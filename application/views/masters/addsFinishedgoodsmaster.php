<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Add New Finished Goods
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">Finished Goods Master</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Add Finished Goods Details</h3>
                        </div>
                        <?php $this->load->helper("form"); ?>
                        <form role="form" id="addnewfinishedgoodsform" action="<?php echo base_url() ?>addnewfinishedgoodsform" method="post" role="form">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                   ...
                                   <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="target_qty" name="target_qty">
                            ...
                            <div class="box-footer">
                                <input type="submit" id="savenewfinishedgoods" class="btn btn-primary" value="Submit" />
