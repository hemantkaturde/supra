<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         <i class="fa fa-users"></i> View Payment Details
         <small>
               ...
               <div class="box box-primary">
                  ...
                  <form role="form" id="addnewpaymentdetailsform" action="#" method="post" role="form">
                        ...
                        <div class="row">
                           <div class="col-md-6 col-sm-6 col-xs-6">
                              <div class="col-md-8 col-sm-8 col-xs-8">
                                  <input readonly  type="hidden" class="form-control" id="payment_details_id" value="<?=$getPaymentdetails[0]['payment_details_id']?>" name="payment_details_id" readonly>
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="payment_details_number">Payment Details Number<span class="required">*</span></label>
                                        <input readonly  type="text" class="form-control" id="payment_details_number" value="<?=$getPaymentdetails[0]['payment_details_number']?>" name="payment_details_number" readonly>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="payment_details_date">Payment Details Date <span class="required">*</span></label>
                                        <input readonly  type="text" class="form-control datepicker"  value="<?=$getPaymentdetails[0]['payment_details_date']?>" id="payment_details_date" name="payment_details_date" required>
                                 ...
                                 <div id="vendor_name_div_for_hide_show" style="display:<?php echo $vendor_display; ?>">
                                    ...
                                    <div class="col-md-12 vendor_po_number_div" id="vendor_po_number_div" style="display:<?php echo  $vendor_display_po; ?>">
                                       <div class="form-group">
                                          ...
                                          <select readonly class="form-control vendor_po_number_itam vendor_po_get_data get_vendorpodata_with_debit_data" name="vendor_po_number" id="vendor_po_number">
                                             <!-- <option st-id="" value="">Select Vendor Name</option> -->
                                 ...
                                 <div id="supplier_name_div_for_hide_show" style="display:<?php echo $supplier_display;?>">
                                    ...
                                    <div class="col-md-12 supplier_po_number_div" id="supplier_po_number_div" style="display:<?php echo  $selected_value_supplier_po; ?>">
                                       <div class="form-group">
                                          ...
                                          <select readonly class="form-control supplier_po_number_item supplier_po_number_for_item supplier_po_get_data get_supplierpodata_debit_data" name="supplier_po_number" id="supplier_po_number">
                                             <!-- <option st-id="" value="">Select Vendor Name</option> -->
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="po_date">PO Date</label>
                                        <input readonly  type="text" class="form-control datepicker" value="<?=$getPaymentdetails[0]['po_date']?>" id="po_date" name="po_date" required>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="tds">TDS<span class="required">*</span></label>
                                        <input readonly  type="text" class="form-control" id="tds" value="<?=$getPaymentdetails[0]['tds']?>" name="tds">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="debit_note_amount">Debit Note Amount<span class="required">*</span></label>
                                        <input readonly  type="text" class="form-control" id="debit_note_amount" value="<?=$getPaymentdetails[0]['debit_note_amount']?>"  name="debit_note_amount">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="debit_note_no">Debit Note No<span class="required">*</span></label>
                                        <input readonly  type="text" class="form-control" id="debit_note_no" value="<?=$getPaymentdetails[0]['debit_note_no']?>" name="debit_note_no">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="bill_number">Bill Number</label>
                                        <input readonly  type="text" class="form-control" id="bill_number" value="<?=$getPaymentdetails[0]['bill_number']?>" name="bill_number">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="bill_date">Bill Date</label>
                                        <input readonly  type="text" class="form-control datepicker" value="<?=$getPaymentdetails[0]['bill_date']?>" id="bill_date" name="bill_date">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="bill_amount">Bill Amount</label>
                                        <input readonly  type="text" class="form-control" id="bill_amount" value="<?=$getPaymentdetails[0]['bill_amount']?>"  name="bill_amount">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="cheque_number">Cheque Number</label>
                                        <input readonly  type="text" class="form-control" id="cheque_number" value="<?=$getPaymentdetails[0]['cheque_number']?>" name="cheque_number">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="cheque_date">Cheque Date</label>
                                        <input readonly  type="text" class="form-control datepicker"   value="<?=$getPaymentdetails[0]['cheque_date']?>" id="cheque_date" name="cheque_date">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label for="amount_paid">Amount Paid</label>
                                        <input readonly  type="text" class="form-control" id="amount_paid"  value="<?=$getPaymentdetails[0]['amount_paid']?>" name="amount_paid">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <select readonly class="form-control payment_status" name="payment_status" id="payment_status">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <textarea readonly type="text" class="form-control" id="remark" name="remark"><?php echo $getPaymentdetails[0]['remarkpayment']?></textarea>
                     ...
                     <div class="box-footer">
                        <div class="col-xs-8">
                           <!--  <input readonly  type="submit" id="savenewpaymentdetails" class="btn btn-primary" value="Submit"> -->
                            <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>paymentdetails'" class="btn btn-default" value="Back" />
                        </div>
                     </div>
                  </form>
               </div>
