<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Rework / Rejection Return (RR)
        ...
        <div class="row">
            <div class="col-xs-6 text-left">
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    ...
                    <li class="active"><a href="javascript:void(0);">Rework / Rejection Return (RR)</a></li>
                </ul>
            </div>
                ...
                <div class="box">
                    <div class="box-body">   
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="view_rework_rejection">
                                <thead>
