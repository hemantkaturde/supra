                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Vendor PO Details</h3>
                        </div>
                        ...
                        <form role="form" id="addnewVendorform" action="<?php echo base_url() ?>addnewVendorform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                 ...
                                 <input readonly  type="hidden" class="form-control"  id="vendor_id" name="vendor_id"  value="<?=$getVendorpodetails[0]['id']?>">   


                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="po_number">PO Number<span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="po_number" name="po_number" value="<?=$getVendorpodetails[0]['po_number']?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="date">Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker"  value="<?=$getVendorpodetails[0]['date']?>" id="date" name="date" required>
                                    ...
                                    <div class="col-md-12 supplier_po_number_div" style="display:<?=$display;?>">
                                            <div class="form-group">
                                                    <label for="supplier_po_number">Select Supplier PO Number <span class="required">*</span></label>
                                                     <select readonly  class="form-control supplier_po_number_for_item supplier_po_number_for_vendor_details" name="supplier_po_number" id="supplier_po_number">
                                 ...
                                 <div class="col-md-12 buyer_po_number_div" style="display:<?=$display;?>">
                                         <div class="form-group">
                                                 <label for="buyer_po_number">Select Buyer PO Number <span class="required">*</span></label>
                                                  <select readonly  class="form-control buyer_po_number_for_item buyer_po_number_for_vendor_details" name="buyer_po_number" id="buyer_po_number">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="quatation_ref_no">Quatation Ref No. <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="quatation_ref_no" value="<?=$getVendorpodetails[0]['quatation_ref_no'];?>" name="quatation_ref_no">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="quatation_date">Quatation Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker" value="<?=$getVendorpodetails[0]['quatation_date'];?>" id="quatation_date" name="quatation_date" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="delivery_date">Delivery Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker"  value="<?=$getVendorpodetails[0]['delivery_date'];?>" i id="delivery_date" name="delivery_date">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="delivery">Delivery </label>
                                             <input readonly  type="text" class="form-control" id="delivery" value="<?=$getVendorpodetails[0]['delivery'];?>" name="delivery">
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="delivery_address">Delivery Address</label>
                                                   <textarea readonly  type="text" class="form-control"  id="delivery_address"  name="delivery_address" required> <?=$getVendorpodetails[0]['delivery_address'];?></textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="work_order">Payment Terms </label>
                                             <input readonly  type="text" class="form-control" id="work_order" value="<?=$getVendorpodetails[0]['work_order'];?>" name="work_order" >
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="remark">Remark</label>
                                                   <textarea readonly  type="text" class="form-control"  id="remark"  name="remark" required> <?=$getVendorpodetails[0]['remark'];?></textarea>
                                    ...
                                    <div class="modal fade" id="addNewModal" role="dialog" aria-labelledby="additem" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form role="form" id="addvendoritemform" action="<?php echo base_url() ?>addvendoritemform" method="post" role="form">
                                              ...
                                              <input readonly  type="hidden" class="form-control"  id="vendor_po_item_id" name="vendor_po_item_id" required readonly>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group row" id="part_number_new">
                                                            <label class="col-sm-3 col-form-label">Part Number <span class="required">*</span> (<small>Finished Goods Master</small>)</label>
                                                            <div class="col-sm-9">
                                                                 <select readonly  class="form-control" name="part_number_1" id="part_number_1" readonly>
                                                                    <option st-id="" value="">Select Part Number</option>
                                                                    <?php foreach ($finishgoodList as $key => $value) {?>        
                                                                        <option value="<?php echo $value['fin_id']; ?>"><?php echo $value['part_number']; ?></option>
                                                                    <?php } ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                             <input readonly  type="type" class="form-control"  id="drawing_number" name="drawing_number" required readonly>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                             <textarea readonly  type="text" class="form-control"  id="description_1"  name="description_1" required></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                             <textarea readonly  type="text" class="form-control"  id="description_2"  name="description_2" required></textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                              <select readonly  class="form-control" name="unit" id="unit" readonly>
...
<option value="Ltr">Ltr</option>
                            ...
                            <div class="box-footer">
                                <div class="col-xs-8">
                                    ...
                                    <!--  <input readonly  type="submit" id="savenewvendorpo" class="btn btn-primary" value="Submit"/> -->
                                     <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>vendorpo'" class="btn btn-default" value="Back" />
                                </div>
                            </div>
                        </form>
                    </div>
