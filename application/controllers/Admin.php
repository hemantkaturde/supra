    ...
    foreach ($getsuppliertemdeatilsForInvoiceonvendorpo as $key => $value) {
        $supplierItem .= '
            <tr style="border-left: 1px solid black;border-right: 1px solid black;">
                ...
                <td style="border-left: 1px solid black;border-right: 1px solid black;text-align:left;padding-left: 15px;" valign="top">'.$i.'.'.$value['type_of_raw_material'].' - '.$value['order_oty'].' kgs * '.$value['rate'].' = '.$value['value'].'</td> 
