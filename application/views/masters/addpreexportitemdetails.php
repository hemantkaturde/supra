                                               ...
                                               <label for="part_number">Part Number <span class="required">*</span></label>
                                                <select class="form-control part_number" name="part_number" id="part_number">
                                                    ...
                                                    <?php foreach ($getbuyerpoitemdetails as $key => $value) { 
                                                        ...
                                                        ?>
                                                    <option value="<?php echo $value['fin_id']; ?>" data_buyer_po_number="<?php echo $value['buyer_po_number'];?>" data_buyer_po_date="<?php echo $value['buyer_po_part_delivery_date'];?>" ><?php echo $value['part_number'].' - '.$value['buyer_po_number'].$buyer_po_part_delivery_date; ?> </option>
                                                    <?php } ?>
                                                </select>
