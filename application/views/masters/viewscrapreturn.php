<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> View Scrap Return
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">View Return Master</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Scrap Return Details</h3>
                        </div>
                        ...
                        <form role="form" id="addnewScrapreturnform" action="<?php echo base_url() ?>addnewScrapreturnform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                     ...
                                     <input readonly  type="hidden" class="form-control" id="challan_table_id" name="challan_table_id" value="<?=$getScrapreturndetails[0]['id']?>" required readonly>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="challan_id">Challan Id<span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="challan_id" name="challan_id" value="<?=$getScrapreturndetails[0]['challan_id']?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="challan_date">Challan Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker"  value="<?=$date?>" id="challan_date" name="challan_date" required>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="remark">Remark</label>
                                                  <textarea readonly type="text" class="form-control"  id="remark"  name="remark" required> <?=$getScrapreturndetails[0]['remarks'];?></textarea>
                                    ...
                                    <div class="modal fade" id="addNewModal" role="dialog" aria-labelledby="additem" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form role="form" id="addscrapreturnform" action="<?php echo base_url() ?>addscrapreturnform" method="post" role="form">
                                             <input readonly  type="hidden" class="form-control"  id="scrap_item_id" name="scrap_item_id" required readonly>
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <select readonly  class="form-control" name="description" id="description">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="gross_weight" name="gross_weight" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="net_weight" name="net_weight" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="quantity" name="quantity" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="number_of_bags" name="number_of_bags" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <select readonly  class="form-control" name="hsn_code" id="hsn_code">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="estimated_value" name="estimated_value" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <select readonly  class="form-control" name="number_of_processing" id="number_of_processing">
                            ...
                            <div class="box-footer">
                                ...
                                <?php if($fetchALLprescrapreturndetailsforview){
                                     ...
                                     <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>scrapreturn'" class="btn btn-default" value="Back" />
                                </div>
                            </div>
                        </form>
                    </div>
