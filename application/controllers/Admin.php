            ...
            <table style="margin-top:10px;width: 100%;text-align: left;border-collapse: collapse;border: #ccc 1px solid;margin-top:10px;margin-bottom:10px;font-family:cambria;font-size:12px">
             ...
             <tr style="border: 1px solid black;">
              ...
              <tr style="border: 1px solid black;">
                ...
                <td style="border: 1px solid black;padding: 5px">'.$getDebitnotedetailsforInvoice['tds_amount'].'<br/><br/>'.round($total_amount_debit,2).'<br/>____________<br/>'.(float)$getDebitnotedetailsforInvoice['tds_amount']+(float)$total_amount_debit.'</td>
              </tr>
