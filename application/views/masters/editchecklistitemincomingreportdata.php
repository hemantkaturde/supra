                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" id="addchecklistpartitemdatavendorincomingform" action="<?php echo base_url() ?>addchecklistreportpartform" method="post" role="form">
                            <div class="box-body">
                                    ...
                                    <input type="hidden" class="form-control" id="checklist_report_id" name="checklist_report_id" value="<?php $geteditchecklistitemincomingreportdata[0]['checklist_report_id']; ?>">
