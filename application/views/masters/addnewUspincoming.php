                  ...
                  <form role="form" id="addstockform" action="#" method="post" role="form">
                     <div class="box-body">
                        <div class="col-md-4">
                                    ...
                                    <?php
                                        ...
                                        if($getPriviousstockid[0]['stock_id_number']){
                                          ...
                                          /* New Logic End Here */
                                            ...
                                            $id_number = 'SQSD'.$financial_year_indian.'0001';
                                        }
                                    ?>
                                        <input type="text" class="form-control" id="id_number" name="id_number" value="<?=$id_number;?>" required >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="usp_date">Date <span class="required">*</span></label>
                                        <?php 
                                       ...
                                       ?>
                                        <input type="text" class="form-control datepicker" id="usp_date" name="usp_date" value="<?=$usp_date?>"  required >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="vendor_challan">Select Vendor / Challan<span class="required">*</span></label>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for="buyer_po">Date</label>
                                       ...
                                       ?>
                                        ...
                                        <input type="text" class="form-control" id="vendor_challan_date" name="vendor_challan_date" value="<?=$pre_vendor_po_date?>" required >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="vendor_name">Challan No</label>
                                            <select class="form-control" name="vendor_name" id="vendor_name">
                                                <option st-id="" value="">Select Challan No</option>
                                                    <?php foreach ($vendorList as $key => $value) {?>
                                                        <option value="<?php echo $value['ven_id']; ?>" <?php if($getStockforminformation[0]['pre_vendor_name']==$value['ven_id']){ echo 'selected'; }?> ><?php echo $value['vendor_name']; ?></option>
                                                    <?php } ?>
                                            </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="report_by">Report By</label>
                                        <input type="text" class="form-control" id="report_by" name="report_by" value="<?=$total_invoice_qty_In_kgs;?>">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="report_date">Report Date</label>
                                        <input type="text" class="form-control" id="report_date" name="report_date" value="<?=$total_invoice_qty_In_kgs;?>">
