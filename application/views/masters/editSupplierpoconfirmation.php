<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Edit Supplier PO Confirmation
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">Edit Supplier PO Confirmation</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Edit PO Confirmation Details</h3>
                        </div>
                        ...
                        <form role="form" id="addnnewsupplierconfrimationpoform" action="<?php echo base_url() ?>addnnewsupplierconfrimationpoform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" class="form-control" id="supplierpoconfirmation_id" name="supplierpoconfirmation_id" value="<?=$supplierpoconfirmationid?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  value="<?=$getSupplierpoconfirmationdetails['date']?>" id="date" name="date" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?=$getSupplierpoconfirmationdetails['confirmed_date'];?>" id="confirmed_date" name="confirmed_date" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="confirmed_with" value="<?=$getSupplierpoconfirmationdetails['confirmed_with'];?>" name="confirmed_with">
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="remark">Remark</label>
                                                  <textarea type="text" class="form-control"  id="remark"  name="remark" required> <?=$getSupplierpoconfirmationdetails['remark'];?></textarea>
