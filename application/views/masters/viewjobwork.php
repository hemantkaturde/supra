<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> View Job Work
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">View Job Work</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Job Work Details</h3>
                        </div>
                        ...
                        <form role="form" id="addnnewjobworkform" action="<?php echo base_url() ?>addnnewjobworkform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                     ...
                                     <input readonly  type="hidden" class="form-control" id="job_work_id" name="job_work_id" value="<?=$jobworkid?>" required readonly>


                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="job_work_no">JoB Work No<span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="job_work_no" name="job_work_no" value="<?=$getalljobworkdetails[0]['job_work_po']?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="date">Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker"  value="<?=$getalljobworkdetails[0]['job_work_date']?>" id="date" name="date" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="remark">Remark</label>
                                             <input readonly  type="text" class="form-control" id="remark" name="remark" value="<?=$getalljobworkdetails[0]['jobwork_remark'] ?>">
                                    ...
                                    <div class="modal fade" id="addNewModal" role="dialog" aria-labelledby="additem" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form role="form" id="savejobworkitemform" action="<?php echo base_url() ?>savejobworkitemform" method="post" role="form">
                                             <input readonly  type="hidden" class="form-control"  id="jobwork_item_id" name="jobwork_item_id" required readonly>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="raw_material_size" name="raw_material_size" readonly>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="rm_actual_aty" name="rm_actual_aty">
...
<option value="Ltr">Ltr</option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="rm_rate" name="rm_rate" readonly>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="value" name="value" readonly>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="packing_and_forwarding"  value="0" name="packing_and_forwarding">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="total" name="total" readonly>
                                                    ...
                                                    <div class="form-group row cgst_sgst_div" style="display:none">
                                                        ...
                                                        <div class="col-sm-4">
                                                             <input readonly  type="number" class="form-control"  id="SGST_rate" name="SGST_rate" readonly>
                                                            <p class="error SGST_rate_error"></p>
                                                        </div>

                                                        <label class="col-sm-2 col-form-label">CGST 9 %<span class="required">*</span></label>
                                                        <div class="col-sm-4">
                                                             <input readonly  type="number" class="form-control"  id="CGST_rate" name="CGST_rate" readonly>
                                                    ...
                                                    <div class="form-group row igst_div" style="display:none">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="igst_rate" name="igst_rate" readonly>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="number" class="form-control"  id="gst" name="gst" readonly>
                            ...
                            <div class="box-footer">
                                <div class="col-xs-8">
                                    <?php if($fetchALLprejobworkitemList){
                                     ...
                                     <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>jobWork'" class="btn btn-default" value="Back" />
                                </div>
                            </div>
                        </form>
                    </div>
