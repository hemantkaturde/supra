                        ...
                        <form role="form" id="addnewPODform" action="#" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                    ...
                                    <input readonly  type="hidden" class="form-control" id="POD_details_id"  name="POD_details_id" value="<?=$getpoddetailsforedit['pod_details_id']?>" readonly>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="POD_details_number">POD Details Number<span
                                                    class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="POD_details_number"  name="POD_details_number" value="<?=$getpoddetailsforedit['pod_details_number']?>" readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="POD_details_date">POD Details Date <span
                                                    class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker" value="<?=$getpoddetailsforedit['pod_details_date']?>"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="vendor_supplier_name">Select Vendor / Supplier <span
                                                    class="required">*</span></label>
                                             <select readonly  class="form-control vendor_supplier_name"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="vendor_name">Vendor Name</label>
                                                 <select readonly  class="form-control vendor_name" name="vendor_name"
                                                    id="vendor_name">
                                        ...
                                        <div class="col-md-12 vendor_po_number_div" id="vendor_po_number_div"
                                            ...
                                            <div class="form-group">
                                                <label for="vendor_po_number">Select Vendor PO Number</label>
                                                 <select readonly  class="form-control vendor_po_number_itam vendor_po_get_data"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="po_date">PO Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker" value="<?=$getpoddetailsforedit['po_date'];?>"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" readonly class="form-control" id="remark"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form role="form" id="savePODitem_form"
                                                    ...
                                                    role="form">
                                                     ...
                                                     <input readonly  type="hidden" class="form-control" id="poditems_id"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Part Number <span
                                                                    ...
                                                                    Master</small>)</label>
                                                            <div class="col-sm-8">
                                                                 <select readonly  class="form-control part_number_for_previous_short_excess" name="part_number"
                                                                    id="part_number">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                 <input readonly  type="type" class="form-control" id="description"
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Order Qty<span
                                                                    class="required">*</span></label>
                                                            <div class="col-sm-8">
                                                                 <input readonly  type="text" class="form-control" id="order_qty"
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label">Qty Recived<span
                                                                    class="required">*</span></label>
                                                            <div class="col-sm-8">
                                                                 <input readonly  type="text" class="form-control" id="qty_recived"
                                                                    name="qty_recived">
...
<option value="Ltr">Ltr</option>
                    ...
                    <div class="box-footer">
                        <div class="col-xs-8">
                             <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>poddetails'"
