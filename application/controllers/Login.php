...
class Login extends BaseController
{
    ...
    public function noaccess() {
        ...
        $this->global['pageTitle'] = 'Admin : Erişim Reddedildi';
        $this->datas();
        ...
        else 
        {
            ...
            if($this->login_model->checkEmailExist($email))
            {
                ...
                if($save)
                {
                    ...
                    if($sendStatus){
                        $status = "send";
                        setFlashData($status, "Your Password Reset link has been successfully sent, please check your mail.");
                    } else {
                        $status = "notsend";
                ...
                {
                    $status = 'unable';
                    setFlashData($status, "An error occurred while sending your information, try again.");
                }
            }
            else
            {
    ...
    function createPasswordUser()
    {
        ...
        else
        {
            ...
            {
                $status = 'error';
                $message = 'Change Passwordilemedi';
            }
