...
$route['editchecklistitemincomingreportdata/(:any)'] = "admin/editchecklistitemincomingreportdata/$1";
...
$route['getlotdetailsforeditincomingdata'] = "admin/getlotdetailsforeditincomingdata";
