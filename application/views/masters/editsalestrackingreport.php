<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Edit Sales Tracking Report
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">Edit Sales Tracking Report</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Edit Tracking Report Details</h3>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="clearance_done_by" value="<?=$getsalestrackingdetailsforedit['clearance_done_by'] ?>" name="clearance_done_by">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="payment_terms" value="<?=$getsalestrackingdetailsforedit['payment_terms']?>" name="payment_terms">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="inv_amount">Inv.Amount</label>
                                              <input type="text" class="form-control" id="inv_amount" value="<?=$getsalestrackingdetailsforedit['inv_amount']?>"  name="inv_amount">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="igst_value"  value="<?=$getsalestrackingdetailsforedit['igst_value']?>" name="igst_value">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="igst_rcved_amt"  value="<?=$getsalestrackingdetailsforedit['igst_rcved_amt']?>" name="igst_rcved_amt">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="igst_rcved_date"  value="<?=$getsalestrackingdetailsforedit['igst_rcved_date']?>"  name="igst_rcved_date">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  id="port_of_discharge" value="<?=$getsalestrackingdetailsforedit['port_of_discharge']?>" name="port_of_discharge">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sb_no" value="<?=$getsalestrackingdetailsforedit['sb_no']?>" name="sb_no">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="sb_date" value="<?=$getsalestrackingdetailsforedit['sb_date']?>" name="sb_date">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fob_amount_rs"  value="<?=$getsalestrackingdetailsforedit['fob_amount_rs']?>" name="fob_amount_rs">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="drawback" value="<?=$getsalestrackingdetailsforedit['drawback']?>" name="drawback">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bl_awb_no" value="<?=$getsalestrackingdetailsforedit['bl_awb_no']?>" name="bl_awb_no">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="bl_awb_date" value="<?=$getsalestrackingdetailsforedit['bl_awb_date']?>" name="bl_awb_date">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="brc_number_and_dt" value="<?=$getsalestrackingdetailsforedit['brc_number_and_dt']?>" name="brc_number_and_dt">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="brc_value" value="<?=$getsalestrackingdetailsforedit['brc_value']?>" name="brc_value">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="foreign_bank_charges" value="<?=$getsalestrackingdetailsforedit['foreign_bank_charges']?>" name="foreign_bank_charges">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="foreign_bank_charges_in_inr" value="<?=$getsalestrackingdetailsforedit['foreign_bank_charges_in_inr']?>" name="foreign_bank_charges_in_inr">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="EGM_status" value="<?=$getsalestrackingdetailsforedit['EGM_status']?>" name="EGM_status">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="carrier_bill_number" value="<?=$getsalestrackingdetailsforedit['carrier_bill_number']?>" name="carrier_bill_number">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="carrier_bill_date"  value="<?=$getsalestrackingdetailsforedit['carrier_bill_date']?>" name="carrier_bill_date">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bill_amt" name="bill_amt" value="<?=$getsalestrackingdetailsforedit['bill_amt']?>">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tds_amt" name="tds_amt" value="<?=$getsalestrackingdetailsforedit['tds_amt']?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cheque_no" name="cheque_no" value="<?=$getsalestrackingdetailsforedit['cheque_no']?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="bill_paid_date" name="bill_paid_date" value="<?=$getsalestrackingdetailsforedit['bill_paid_date']?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dbk_recd_amount" name="dbk_recd_amount" value="<?=$getsalestrackingdetailsforedit['dbk_recd_amount']?>">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="dbk_recd_date" name="dbk_recd_date" value="<?=$getsalestrackingdetailsforedit['dbk_recd_date']?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="rodtep" name="rodtep" value="<?=$getsalestrackingdetailsforedit['rodtep']?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="escript_number_license_no" name="escript_number_license_no" value="<?=$getsalestrackingdetailsforedit['escript_number_license_no']?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="payment_recvd_date" name="payment_recvd_date" value="<?=$getsalestrackingdetailsforedit['payment_recvd_date']?>" required>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="payment_rcivd_amt" value="<?=$getsalestrackingdetailsforedit['payment_rcivd_amt']?>" name="payment_rcivd_amt">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="payment_exchange_amt" value="<?=$getsalestrackingdetailsforedit['payment_exchange_amt']?>" name="payment_exchange_amt">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="realised_amt_in_inr"  value="<?=$getsalestrackingdetailsforedit['realised_amt_in_inr']?>"  name="realised_amt_in_inr">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bank_charges_inr"  value="<?=$getsalestrackingdetailsforedit['bank_charges_inr']?>" name="bank_charges_inr">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="debit_note_date" value="<?=$getsalestrackingdetailsforedit['debit_note_date']?>"  name="debit_note_date">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  id="receivable_amt_debit" value="<?=$getsalestrackingdetailsforedit['receivable_amt_debit']?>" name="receivable_amt_debit">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="difference_debit_note_amt" value="<?=$getsalestrackingdetailsforedit['difference_debit_note_amt']?>" name="difference_debit_note_amt">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="debit_amount_reason" value="<?=$getsalestrackingdetailsforedit['debit_amount_reason']?>" name="debit_amount_reason">
                                ...
                                <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exchange_rate_as_per_sb" value="<?=$getsalestrackingdetailsforedit['exchange_rate_as_per_sb']?>" name="exchange_rate_as_per_sb">
