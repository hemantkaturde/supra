<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         <i class="fa fa-users"></i> Edit Quality Record
         <small>
            ...
            <div class="box">
               <div class="box box-primary">
                  <div class="box-header">
                     <h3 class="box-title">Edit Quality Record</h3>
                  </div>
                        ...
                        <div class="col-md-4">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker"  value="<?=$getqualityrecords_details['quality_records_date']?>" id="QR_details_date" name="QR_details_date" required>
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker"  Value="<?=$getqualityrecords_details['po_date'];?>" id="vedor_po_date" name="vedor_po_date" readonly>
