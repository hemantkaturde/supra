<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Vendor PO Item Attachment
            <small>
    ...
    <div class="row">
            <div class="col-xs-6 text-left">
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                   ...
                   <h4>
                                <p><b>Vendor PO Number :</b> <?=$getvendorpoitemattachmentdetails[0]['po_number'] ?></p>
                                <p><b>Vendor Name :</b> <?=$getvendorpoitemattachmentdetails[0]['ven_name'] ?></p>
                                <p><b>Part Number :</b> <?=$getvendorpoitemattachmentdetails[0]['part_number_label'] ?></p>
                            </h4>

            <input type="hidden" class="form-control" id="vendoritemid_main" name="vendoritemid_main" value="<?=$getvendorpoitemattachmentdetails[0]['vendor_po_item_id'];?>">
                ...
                <?php if($this->session->userdata('roleText')=='Superadmin' || $this->session->userdata('roleText')=='Purchase' || $this->session->userdata('roleText')=='QC'){ ?>
                    <!-- <a class="btn btn-primary" href="<?php echo base_url(); ?>addTDIRattachment">
                        ...
                        <a href="#fileModal" class="btn btn-primary" data-toggle="modal">
                          <i class="fa fa-plus"></i> Add Vendor PO Item Attachment
                        </a>
                <?php } ?>
                </div>
            </div>
                        ...
                        <div class="box-body">
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover"
                                    id="view_vendor_po_item_attachedment">
                                    <thead>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="fileModalLabel">Upload Vendor PO Item Attachment</h4>
      </div>
      ...
      <div class="modal-body">
        <form id="fileUploadForm" enctype="multipart/form-data">
          ...
          <input type="hidden" class="form-control" id="vendorpoitemid" name="vendorpoitemid" value="<?=$getvendorpoitemattachmentdetails[0]['vendor_po_item_id'];?>">
        </form>
