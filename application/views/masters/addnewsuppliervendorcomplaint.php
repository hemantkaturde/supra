                        ...
                        <form role="form" id="addnewsuppliervendorcomplaintform" action="<?php echo base_url() ?>addnewsuppliervendorcomplaint" method="post" role="form">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="supplier_vendor">Select Supplier / Vendor</label>
                                            <select class="form-control" name="supplier_vendor" id="supplier_vendor">
                                                  <option value="NA">Select Customer Name</option>
                                                  <option value="Supplier">Supplier</option>
                                                  <option value="Vendor">Vendor</option>
                                            </select>
                                            <p class="error supplier_vendor_error"></p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="part_description" name="part_description">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="received_qty" name="received_qty">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="total_failure_qty" name="total_failure_qty">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="date_1" name="date_1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="date_3" name="date_3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="date_4" name="date_4">
