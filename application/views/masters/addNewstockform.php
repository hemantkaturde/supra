                        ...
                        <div class="col-md-4">
                           <?php
                              if($get_prevoius_QR_REcord[0]['quality_records_number']){
                                  ...
                                  $quality_records_number = 'SQSD23240001';
                              }
                              ?>
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="QR_details_number">Stock ID<span class="required">*</span></label>
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="QR_details_date">Stock Date <span class="required">*</span></label>
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="vedor_po_date">Vendor PO Date </label>
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="vedor_po_date">Buyer PO Date </label>
                                    <input type="text" class="form-control datepicker"  id="vedor_po_date" name="vedor_po_date" readonly>
                                    <p class="error vedor_po_date_error"></p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label for="vedor_po_date">Delivery </label>
                                    <input type="text" class="form-control"  id="vedor_po_date" name="vedor_po_date">
                                    <p class="error vedor_po_date_error"></p>
                                 </div>
                              </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form role="form" id="savequlityrecord_form" action="#" method="post" role="form">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Buyer Order Qty<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">F.G Order Qty<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Invoice Qty (In Pics)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Invoice Qty (In KGS)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Lot No<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Actual Recived Qty (In Pics)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Actual Recived Qty (In KGS)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Previous Balenced<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Export Invoice Number<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Export Invoice Date<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Export Qty (In Pics)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Export Qty (In KGS)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Export Date<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Rejection Number<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Rejection Reason<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Rejection Qty (In Pics)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Rejection Qty (In KGS)<span class="required">*</span></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control"  id="inspected_by" name="inspected_by">
                                                            <p class="error inspected_by_error"></p>
                                                        </div>
