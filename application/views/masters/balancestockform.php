<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Balance Stock
        ...
        <div class="row">
            <div class="col-xs-6 text-left">
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    ...
                    <li class="active"><a href="javascript:void(0);">Balance Stock</a></li>
                </ul>
            </div>
            <div class="col-xs-6 text-right">
                <div class="form-group">
                    <?php if($this->session->userdata('roleText')=='Superadmin' || $this->session->userdata('roleText')=='Purchase' || $this->session->userdata('roleText')=='Stock' ){ ?>
                        <a class="btn btn-primary" href="<?php echo base_url(); ?>addnewbalancestock">
                            <i class="fa fa-plus"></i> Add Balance Stock</a>
                    <?php } ?>
                </div>
            </div>
        </div>
                ...
                <div class="box">
                    <div class="box-body">   
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="view_balance_stock">
                                <thead>
