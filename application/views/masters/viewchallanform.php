<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> View Challan Form
            <small>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Challan Form</h3>
                        </div>
                        <?php $this->load->helper("form"); ?>
                        <form role="form" id="addnnewchallanform" action="<?php echo base_url() ?>addchallanform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                 <input readonly  type="hidden" class="form-control" id="challan_id" value="<?=$getChallanformdetails[0]['challan_id']?>" name="challan_id" readonly>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="challan_no">Challan No<span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="challan_no" value="<?=$getChallanformdetails[0]['challan_no']?>" name="challan_no" readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="challan_date">Challan Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker"  value="<?=$getChallanformdetails[0]['challan_date']?>" id="challan_date" name="challan_date" required>
                                    ...
                                    <div class="col-md-12" >
                                            <div class="form-group">
                                                    <label for="usp">USP </label>
                                                     <select readonly  class="form-control usp" name="usp" id="usp">
                                        ...
                                        <div class="form-group">
                                            <label for="dispatched_by">Dispatched by</label>
                                             <input readonly  type="text" class="form-control" id="dispatched_by" value="<?=$getChallanformdetails[0]['dispatched_by']?>" name="dispatched_by" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="total_gross_weight_in_kgs">Total Gross Weight In kgs</label>
                                             <input readonly  type="text" class="form-control" id="total_gross_weight_in_kgs" value="<?=$getChallanformdetails[0]['total_gross_weight_in_kgs']?>" name="total_gross_weight_in_kgs" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="total_netweight_in_kgs">Total Net Weight In kgs</label>
                                             <input readonly  type="text" class="form-control" id="total_netweight_in_kgs" value="<?=$getChallanformdetails[0]['total_netweight_in_kgs']?>" name="total_netweight_in_kgs" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="no_of_bags_boxs_goni">No of Bags/Boxes/Goni </label>
                                             <input readonly  type="text" class="form-control" id="no_of_bags_boxs_goni" value="<?=$getChallanformdetails[0]['no_of_bags_boxs_goni']?>" name="no_of_bags_boxs_goni" required>
                                    ...
                                    <div class="col-md-12" >
                                            <div class="form-group">
                                                    <label for="paid_unpaid">Paid/Unpaid </label>
                                                     <select readonly  class="form-control paid_unpaid" name="paid_unpaid" id="paid_unpaid">
                                                        <option st-id="" value="">Select Paid/Unpaid</option>
                                                        <option value="Paid" <?php if($getChallanformdetails[0]['paid_unpaid']=='Paid'){ echo 'selected';} ?>>Paid</option>
                                                        <option value="Unpaid" <?php if($getChallanformdetails[0]['paid_unpaid']=='Unpaid'){ echo 'selected';} ?>>Unpaid</option>
                                                    </select>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="remark">Remark</label>
                                                  <textarea readonly type="text" class="form-control"  id="remark"  name="remark" required> <?=$getChallanformdetails[0]['rejectionremark'];?></textarea>
                                      ...
                                      <div class="modal fade" id="addNewModal" role="dialog" aria-labelledby="additem" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form role="form" id="addnnewreworkrejectionitemform" action="<?php echo base_url() ?>addnnewreworkrejectionitemform" method="post" role="form">
                                             <input readonly  type="hidden" class="form-control"  id="challan_form_item_id" name="challan_form_item_id" required readonly>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="type_of_raw_platting" name="type_of_raw_platting">
                            ...
                            <div class="box-footer">
                                <div class="col-xs-8">
                                    <?php if($fetchALLprejobworkitemList){
                                     ...
                                     <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>challanform'" class="btn btn-default" value="Back" />
                                </div>
                            </div>
                        </form>
                    </div>
