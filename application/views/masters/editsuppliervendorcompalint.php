...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Edit Supplier Vendor Complaint Form
            <small>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Edit Supplier Vendor Complaint</h3>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="report_number" name="report_number" value="<?=$getsuppliervendorcomplaintdata['report_number']?>" readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="part_description" value="<?=$getsuppliervendorcomplaintdata['part_description']?>" name="part_description">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="received_qty" value="<?=$getsuppliervendorcomplaintdata['received_qty']?>" name="received_qty">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="total_quantity_checked" value="<?=$getsuppliervendorcomplaintdata['total_quantity_checked']?>" name="total_quantity_checked">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="problem_description" value="<?=$getsuppliervendorcomplaintdata['problem_description']?>" name="problem_description">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="root_case" value="<?=$getsuppliervendorcomplaintdata['root_case']?>" name="root_case">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="effective_action" value="<?=$getsuppliervendorcomplaintdata['effective_action']?>" name="effective_action">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="responsibility_1" value="<?=$getsuppliervendorcomplaintdata['responsibility_1']?>"  name="responsibility_1">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="date_1" value="<?=$getsuppliervendorcomplaintdata['date_1']?>"  name="date_1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="responsibility_2"  value="<?=$getsuppliervendorcomplaintdata['responsibility_2']?>" name="responsibility_2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="date_2" value="<?=$getsuppliervendorcomplaintdata['date_2']?>" name="date_2">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="prepared_by" value="<?=$getsuppliervendorcomplaintdata['prepared_by']?>" name="prepared_by">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="date_3" value="<?=$getsuppliervendorcomplaintdata['date_3']?>" name="date_3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="apprroved_by" value="<?=$getsuppliervendorcomplaintdata['apprroved_by']?>" name="apprroved_by">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="date_4" value="<?=$getsuppliervendorcomplaintdata['date_4']?>" name="date_4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="complaint_raised_by" name="complaint_raised_by" value="<?=$getsuppliervendorcomplaintdata['complaint_raised_by']?>">
