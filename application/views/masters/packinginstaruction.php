        ...
        <div class="row">
            <div class="col-xs-6 text-left">
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    ...
                    <li class="active"><a href="javascript:void(0);">Packing Instructions</a></li>
                </ul>
            </div>
                ...
                <div class="box">
                    <div class="box-body">   
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="view_Packing_Instarction">
                                <thead>
