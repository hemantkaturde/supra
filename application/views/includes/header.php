                    ...
                    <?php }else{ ?>
                      ...
                      <li class="treeview <?php if($pageUrl=="supplierpo" || $pageUrl=="addnewSupplierpo" || $pageUrl=="viewSupplierpo" 
                        ...
                        <ul class="treeview-menu" >
                          ...
                          <li class="line_height <?php if($pageUrl=="packing_challan" || $pageUrl=="addnewpackingchallan"){echo 'active';}?>"><a href="<?php echo base_url(); ?>packing_challan"><i class="fa fa-cubes"></i> Packing Challan</a></li>
