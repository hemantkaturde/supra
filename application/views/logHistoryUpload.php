<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Upload BackupLogme Process</small>
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
Select your sql or gz.sql file for Upload Backupme operation</h3>
                        <div class="box-tools">
                        </div>
                    </div>
                    <!-- /.box-header -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="optionfilebackup" name="optionfilebackup">
                                                        <option value="0">Select Spare</option>
                                                        <?php
                                            if(!empty($backups))
                                            {
...
For Upload Backupme, you need to select backup from server or Select file.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
