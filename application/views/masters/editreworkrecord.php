                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="after_rework_checked_by" id="after_rework_checked_by" value="<?php echo $getreworkrecorddatabyid[0]['after_rework_checked_by'];?>">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rework_done_by" id="rework_done_by" value="<?php echo $getreworkrecorddatabyid[0]['rework_done_by'];?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker" name="checking_date" id="checking_date" value="<?php echo $getreworkrecorddatabyid[0]['checking_date'];?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="authorized_by" value="<?php echo $getreworkrecorddatabyid[0]['authorized_by'];?>" id="authorized_by">
