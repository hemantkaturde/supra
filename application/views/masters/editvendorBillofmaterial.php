<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Edit Vendor Bill of Material
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">Edit Vendor Bill of Material</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Edit Vendor Bill of Material Details</h3>
                        </div>
                        ...
                        <form role="form" id="addnnewvendorbillofmaterialform" action="<?php echo base_url() ?>addnnewvendorbillofmaterialform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" class="form-control" id="editvbmid" name="editvbmid" value="<?=$fetchALLVendorbillofmaterialdetails['vbom_id']?>" required readonly>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="bom_number">BOM Number<span class="required">*</span></label>
                                            <input type="text" class="form-control" id="bom_number" name="bom_number" value="<?=$fetchALLVendorbillofmaterialdetails['bom_number']?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datepicker"  value="<?=$fetchALLVendorbillofmaterialdetails['bom_date']?>" id="date" name="date" required>
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="buyer_po_date" value="<?=$fetchALLVendorbillofmaterialdetails['buyer_po_date']?>" name="buyer_po_date" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="buyer_delivery_date" value="<?=$fetchALLVendorbillofmaterialdetails['buyer_delivery_date']?>"  name="buyer_delivery_date" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="remark"  value="<?=$fetchALLVendorbillofmaterialdetails['remark']?>" name="remark">
