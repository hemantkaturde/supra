<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         <i class="fa fa-users"></i> View Stock Form
         <small>
            <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
               <li class="completed"><a href="javascript:void(0);">Masters</a></li>
               <li class="active"><a href="javascript:void(0);"> View Stock Details</a></li>
            </ul>
         </small>
      </h1>
   </section>
            ...
            <div class="box">
               <div class="box box-primary">
                  <div class="box-header">
                     <h3 class="box-title">View Stock Form Details</h3>
                  </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="stock_id">Stock Id <span class="required">*</span></label>
                                        <input readonly type="hidden" class="form-control" id="stock_id_main" name="stock_id_main" value="<?=$getStockdetailsData['stock_id']?>"  required >
                                        <input readonly type="text" class="form-control" id="stock_id" name="stock_id" value="<?=$getStockdetailsData['stock_id_number']?>" required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="stock_date">Stock Date <span class="required">*</span></label>
                                        <input readonly type="text" class="form-control datepicker" id="stock_date" name="stock_date" value="<?=$getStockdetailsData['stock_date']?>"  required >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="buyer_po">Vendor PO Date</label>
                                        <input readonly type="text" class="form-control" id="vendor_po_date" name="vendor_po_date" value="<?=$getStockdetailsData['vendor_po_date']?>" required readonly>
                                ...
                                <div class="form-group">
                                    <label for="buyer_po_number">Buyer PO Number</label>
                                      <?php 
                                       ...
                                       ?>
                                    <input readonly type="hidden" class="form-control" id="buyer_po_id" name="buyer_po_id" value="<?=$pre_buyer_po_id?>" required readonly>
                                     <input readonly type="text" class="form-control" id="buyer_po_number" name="buyer_po_number" value="<?=$pre_buyer_po_number?>" required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php 
                                     ...
                                     <input readonly type="text" class="form-control" id="buyer_po_date" name="buyer_po_date" value="<?=$pre_buyer_po_date?>" required readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php 
                                       ...
                                       ?>
                                        ...
                                        <input readonly type="text" class="form-control" id="buyer_delivery_date"  name="buyer_delivery_date" value="<?=$pre_buyer_delivery_date?>" required readonly>
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                    <label for="Invoice_qty_in_pcs">Invoice Qty (In pcs)</label>
                                        ...
                                        <input readonly type="text" class="form-control" id="Invoice_qty_in_pcs" name="Invoice_qty_in_pcs" value="<?=$total_invoice_qty_In_pcs;?>" required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="Invoice_qty_in_kgs">Invoice Qty (In Kgs)</label>
                                        ...
                                        <input readonly type="text" class="form-control" id="Invoice_qty_in_kgs" name="Invoice_qty_in_kgs" value="<?=$total_invoice_qty_In_kgs;?>" required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="actual_received_qty_in_pcs">Actual received Qty (In Pcs)</label>
                                        ...
                                        ?>
                                        <input readonly type="text" class="form-control" id="actual_received_qty_in_pcs" name="actual_received_qty_in_pcs" value="<?=$total_actual_received_qty_in_pcs;?>"  readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="actual_received_qty_in_kgs">Actual received Qty (In Kgs)</label>
                                        ...
                                        ?>
                                        <input readonly type="text" class="form-control" id="actual_received_qty_in_kgs" name="actual_received_qty_in_kgs" value="<?=$total_actual_received_qty_in_kgs;?>"  required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                        <label for="balance_qty_in_kgs">Remark</label>
                                           <input readonly type="remark" class="form-control" id="remark" value="<?=$getStockdetailsData['stock_remark']?>" name="remark">
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for="total_rejected_in_pcs">Total Rejected Qty (In Pcs)</label>
                                        <input readonly type="text" class="form-control" id="total_rejected_in_pcs" name="total_rejected_in_pcs"  required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="total_rejected_in_pcs_kgs">Total Rejected Qty (In Kgs)</label>
                                        <input readonly type="text" class="form-control" id="total_rejected_in_pcs_kgs" name="total_rejected_in_pcs_kgs"  required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="reday_for_export_pcs">Ready For Export (In Pcs)</label>
                                        <input readonly type="text" class="form-control" id="reday_for_export_pcs" name="reday_for_export_pcs"  required readonly>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for="reday_for_export_kgs">Ready For Export (In Kgs)</label>
                                        <input readonly type="text" class="form-control" id="reday_for_export_kgs" name="reday_for_export_kgs"  required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="total_rejection_qty_kgs">Total Rejection Qty (In Kgs)</label>
                                        <input readonly type="text" class="form-control" id="total_rejection_qty_kgs" name="total_rejection_qty_kgs"  required readonly>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for="total_export_qty_pcs">Total Export Qty (In Pcs)</label>
                                        <input readonly type="text" class="form-control" id="total_export_qty_pcs" name="total_export_qty_pcs"  required readonly>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for="total_export_qty_kgs">Total Export Qty (In Kgs)</label>
                                        <input readonly type="text" class="form-control" id="total_export_qty_kgs" name="total_export_qty_kgs"  required readonly>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for="balance_qty_in_pics">Balance Qty (In Pics)</label>
                                        <input readonly type="text" class="form-control" id="balance_qty_in_pics" name="balance_qty_in_pics"  required readonly>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for="balance_qty_in_kgs">Balance Qty (In Kgs)</label>
                                        <input readonly type="text" class="form-control" id="balance_qty_in_kgs" name="balance_qty_in_kgs"  required readonly>
...
<!-- 
                     ...
                     <div class="box-footer">
                        <div class="col-xs-8">
                           <input readonly type="button" onclick="location.href = '<?php echo base_url() ?>stockform'" class="btn btn-default" value="Back" />
                        </div>
                     </div>
                  </form>
               </div>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            ...
                                            <form role="form" id="saveBillofmaterialform" action="<?php echo base_url() ?>saveBillofmaterialform" method="post" role="form">
                                                <div class="modal-body">
                                                    ...
                                                    <input readonly type="hidden" class="form-control"  id="stock_form_item_id" name="stock_form_item_id" required readonly>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" class="form-control" id="buyre_order_qty" name="buyre_order_qty" readonly>
                                                                <p class="error buyre_order_qty_error"></p>
                                                            </div>
                                                        
                                                            <div class="form-group">
                                                                <label for="fg_order_qty">F.G Order Qty</label>
                                                                <input readonly type="text" class="form-control" id="fg_order_qty" name="fg_order_qty" readonly>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" class="form-control" id="invoice_number" name="invoice_number">
                                                            ...
                                                            <?php $Invoice_date= date('Y-m-d'); ?>
                                                                ...
                                                                <input readonly type="text" class="form-control datepicker" id="invoice_date" value="<?=$Invoice_date?>" name="invoice_date">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="invoice_qty_in_pcs">Invoice Qty (In Pcs) </label>
                                                                <input readonly type="text" class="form-control" id="invoice_qty_in_pcs" name="invoice_qty_in_pcs">
                                                                <p class="error invoice_qty_in_pcs_error"></p>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="invoice_qty_in_kgs">Invoice Qty (In Kgs) </label>
                                                                <input readonly type="text" class="form-control" id="invoice_qty_in_kgs" name="invoice_qty_in_kgs" readonly>
                                                                <p class="error invoice_qty_in_kgs_error"></p>
                                                            </div>
                                                        
                                                            <div class="form-group">
                                                                <label for="actaul_recived_qty_in_pics">Actual Received Qty (In Pcs) </label>
                                                                <input readonly type="text" class="form-control" id="actaul_recived_qty_in_pics" name="actaul_recived_qty_in_pics">
                                                                <p class="error actaul_recived_qty_in_pics_error"></p>
                                                            </div>

                                                            <input readonly type="hidden" class="form-control" id="net_weight" name="net_weight">

                                                        
                                                            <div class="form-group">
                                                                <label for="actaul_recived_qty_in_kgs">Actual Received Qty (In kgs) </label>
                                                                <input readonly type="text" class="form-control" id="actaul_recived_qty_in_kgs" name="actaul_recived_qty_in_kgs" readonly>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" class="form-control" id="privious_balenace" value="0" name="privious_balenace">
