...
class Admin_model extends CI_Model
{
    ...
    public function getSupplierdata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['action'] = '';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."updateSupplier/".$value['sup_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   ";
    ...
    public function getVendordata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['contact_person'] =  $value['contact_person'];
                $data[$counter]['action'] = '';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."updateVendor/".$value['ven_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   ";
    ...
    public function getUspdata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['contact_person'] =  $value['contact_person'];
                $data[$counter]['action'] = '';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."updateUSP/".$value['usp_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   ";
    ...
    public function getPlattingdata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['action'] = '';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."updatePlattingmaster/".$value['id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   ";
    ...
    public function getRejectiondata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['action'] = '';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."updateRejectionmaster/".$value['rejec_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   ";
    ...
    public function getBuyerCount($params){
        ...
        if($params['search']['value'] != "") 
        {
            ...
            $this->db->or_where(TBL_BUYER_MASTER.".country LIKE '%".$params['search']['value']."%'");
    ...
    public function getSupplierPonumbeforsuppliervendorcompalint($supplier_name){
    ...
    public function getVendoritemsonly($vendor_po_number,$flag){
        ...
        $this->db->select('*,'.TBL_VENDOR_PO_MASTER_ITEM.'.id as vendor_po_item_id');
        // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
    ...
    public function getSuppliergoodsPartnumberByidvendorpoconfirmation($part_number,$flag,$vendor_po_number,$poitemid){

        if($flag=='Supplier'){

            // $this->db->select('*,'.TBL_VENDOR_PO_MASTER_ITEM.'.order_oty as vendor_order_qty,'.TBL_VENDOR_PO_MASTER_ITEM.'.vendor_qty as supplier_order_qty,'.TBL_SUPPLIER_PO_CONFIRMATION_ITEM.'.sent_qty as supplier_sent_qty');
            // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
            // $this->db->join(TBL_VENDOR_PO_MASTER_ITEM, TBL_VENDOR_PO_MASTER_ITEM.'.part_number_id = '.TBL_FINISHED_GOODS.'.fin_id');
            // $this->db->join(TBL_VENDOR, TBL_VENDOR.'.ven_id = '.TBL_VENDOR_PO_MASTER_ITEM.'.pre_vendor_name');
            // $this->db->join(TBL_SUPPLIER_PO_CONFIRMATION_ITEM, TBL_SUPPLIER_PO_CONFIRMATION_ITEM.'.part_number_id = '.TBL_RAWMATERIAL.'.raw_id');
            // $this->db->join(TBL_SUPPLIER_PO_CONFIRMATION_ITEM.' as a', 'a.vendor_id = '.TBL_VENDOR.'.ven_id');


            // $this->db->where(TBL_FINISHED_GOODS.'.status',1);
            // $this->db->where(TBL_FINISHED_GOODS.'.fin_id',$part_number);
            // $this->db->where(TBL_SUPPLIER_PO_CONFIRMATION_ITEM.'.part_number_id',$part_number);
    ...
    public function getJobworkdata($params){
        ...
        $this->db->select('*,'.TBL_VENDOR_PO_MASTER.'.po_number as vendorpo,'.TBL_VENDOR.'.vendor_name as vendorname,'.TBL_SUPPLIER.'.supplier_name as 	suppliername,'.TBL_JOB_WORK.'.id as jobworkid,'.TBL_JOB_WORK.'.po_number as jobworkponumber,'.TBL_JOB_WORK.'.date as jobwork_challan_date');
        $this->db->join(TBL_VENDOR, TBL_VENDOR.'.ven_id= '.TBL_JOB_WORK.'.vendor_name');
        $this->db->join(TBL_SUPPLIER, TBL_SUPPLIER.'.sup_id= '.TBL_JOB_WORK.'.raw_material_supplier','left');
        $this->db->join(TBL_VENDOR_PO_MASTER, TBL_VENDOR_PO_MASTER.'.id= '.TBL_JOB_WORK.'.vendor_po_number');
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['date'] = $value['jobwork_challan_date'];
    ...
    public function  get_previous_item_balenace_qty_add_self_item($part_number,$incoming_details_item_id){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                if($this->session->userdata('roleText')=='Superadmin'){
                    ...
                    if($this->session->userdata('roleText')=='Sales' || $this->session->userdata('roleText')=='Stock'){
                        $data[$counter]['action'] .= "<a href='".ADMIN_PATH."viewpackinginstraction/".$value['packinginstarctionid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-file-text-o' aria-hidden='true'></i></a>   &nbsp ";
                        $data[$counter]['action'] .= "<a href='".ADMIN_PATH."editpackinginstraction/".$value['packinginstarctionid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   &nbsp ";
                        $data[$counter]['action'] .= "<a href='".ADMIN_PATH."addpackinginstractiondetails/".$value['packinginstarctionid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-plus-circle' aria-hidden='true'></i></a>   &nbsp ";
                        $data[$counter]['action'] .= "<i style='font-size: x-large;cursor: pointer;' data-id='".$value['packinginstarctionid']."' class='fa fa-trash-o deletepackinginstraction' aria-hidden='true'></i>  &nbsp ";
    ...
    //             $data[$counter]['action'] = '';
    //             $data[$counter]['action'] .= "<a href='".ADMIN_PATH."editexportdetails/".$value['export_details_idauto']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   &nbsp ";
    //             $data[$counter]['action'] .= "<a href='".ADMIN_PATH."addExportdetailsitems/".$value['export_details_idauto']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-plus-circle' aria-hidden='true'></i></a>   &nbsp ";
    ...
    public function getExportdetailsdata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['buyer_po_date'] = $value['buyer_po_date'];
                $data[$counter]['action'] = '';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."viewexportdetails/".$value['packinginstarctionid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-file-text-o' aria-hidden='true'></i></a>   &nbsp ";
                $counter++; 
            }
        }
    ...
    public function fetchcurrentorderstatusreportdata($params,$vendor_name,$status){
        ...
        /* Bill of material Data */
                            ...
                            '.TBL_BILL_OF_MATERIAL.'.bom_status,
                            '.TBL_BILL_OF_MATERIAL_ITEM.'.vendor_order_qty as vendor_order_qty_co,
    ...
    public function getdebitnoteitemdetailsedit($id,$vendor_supplier_name){
    ...
    public function getpoddetailsdata($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['action'] = '';
                if($this->session->userdata('roleText')=='Superadmin'){
                    $data[$counter]['action'] .= "<a href='".ADMIN_PATH."viewpoddetails/".$value['pod_details_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-file-text-o' aria-hidden='true'></i></a>   &nbsp ";
                    $data[$counter]['action'] .= "<a href='".ADMIN_PATH."editpoddetails/".$value['pod_details_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   &nbsp ";
    ...
    public function getItemdetailsdependonvendorpoforstockform($part_number,$vendor_po_number,$vendor_name,$buyer_po_id){
    ...
    public function getItemdetailsdependonvendorpoforstockformOMSChallan($part_number,$vendor_po_number,$vendor_name){
    ...
    public function getsearchstockformdata($params,$sock_id,$part_number_id){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['previous_balance'] =$value['previous_balence'];
    ...
    public function getexportrejecteditemdataforprint($part_number,$vendor_po_id){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['qty_In_pcs'] =$value['qty_In_pcs'];
                $data[$counter]['qty_In_kgs'] =round($value['qty_In_kgs'],3);
                $data[$counter]['remarksrej'] =$value['remarksrej'];
                //$data[$counter]['qty_In_kgs'] =$value['fg_net_weight'] * $value['qty_In_kgs'];
  ...
  public function getallbalencecalculationexportitems($sock_id,$part_number_id){
    ...
    // $this->db->select('*,'.TBL_FINISHED_GOODS.'.net_weight as fg_net_weight');
        ...
        /* for Previous Bal In search Stock calculation Always lot nunber for stock form*/
         $this->db->select('previous_balence as balence_qty_in_pcs,sum('.TBL_STOCKS_ITEM.'.balence_qty_in_kgs) as balence_qty_in_kgs,'.TBL_FINISHED_GOODS.'.net_weight as fg_net_weight');
         $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_STOCKS_ITEM.'.part_number');
         $this->db->where(TBL_STOCKS_ITEM.'.status', 1);
         $this->db->where(TBL_STOCKS_ITEM.'.stock_form_id',$sock_id);
         $this->db->where(TBL_STOCKS_ITEM.'.part_number',$part_number_id);
  ...
  public function geteditDebitnoteitemedit($id,$vendor_supplier_name){
  ...
  public function geteditpackinginstractionsubitem( $id){
   ...
   public function getVendoritemonlyforpod($vendor_po_number,$flag){
        ...
        if($check_if_supplier_exist['supplier_po_number']){
            $this->db->select('*,'.TBL_FINISHED_GOODS.'.fin_id as fin_id,'.TBL_VENDOR_PO_MASTER_ITEM.'.id as vendor_po_item_id');
            $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_VENDOR_PO_MASTER_ITEM.'.part_number_id');
            // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
            $this->db->where(TBL_FINISHED_GOODS.'.status',1);
            //$this->db->where(TBL_FINISHED_GOODS.'.fin_id',$part_number);
   ...
   public function getpreviuousenquirynumber(){
    ...
    //     $this->db->select(TBL_BUYER_PO_MASTER.'.buyer_po_date,'.TBL_BUYER_PO_MASTER.'.sales_order_number,'.TBL_BUYER_MASTER.'.buyer_name,'.TBL_BUYER_PO_MASTER.'.buyer_po_number,'.TBL_BUYER_PO_MASTER.'.date,'.TBL_FINISHED_GOODS.'.part_number,'.TBL_FINISHED_GOODS.'.name,'.TBL_BUYER_PO_MASTER_ITEM.'.order_oty,'.TBL_BUYER_PO_MASTER_ITEM.'.buyer_po_part_delivery_date,'.TBL_BUYER_PO_MASTER.'.id as buyer_po_idpo,'.TBL_BUYER_PO_MASTER_ITEM.'.part_number_id as part_number_id_buyer_Po,'.TBL_PACKING_INSTRACTION_DETAILS.'.buyer_invoice_number');
    //     $this->db->join(TBL_PACKING_INSTRACTION_DETAILS, TBL_BUYER_PO_MASTER_ITEM.'.part_number_id = '.TBL_PACKING_INSTRACTION_DETAILS.'.part_number','left');
    //     $this->db->join(TBL_BUYER_PO_MASTER, TBL_BUYER_PO_MASTER.'.id = '.TBL_BUYER_PO_MASTER_ITEM.'.buyer_po_id');
    //     $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_BUYER_PO_MASTER_ITEM.'.part_number_id');
    //     $this->db->join(TBL_BUYER_MASTER, TBL_BUYER_MASTER.'.buyer_id = '.TBL_BUYER_PO_MASTER.'.buyer_name_id');
    //     // $this->db->join(TBL_PACKING_INSTRACTION, TBL_PACKING_INSTRACTION.'.id = '.TBL_BUYER_PO_MASTER.'.packing_instract_id');
    //     // $this->db->join(TBL_PACKING_INSTRACTION, TBL_PACKING_INSTRACTION.'.id = '.TBL_PACKING_INSTRACTION_DETAILS.'.packing_instract_id');
   ...
   /*31-08-2024*/
    ...
    public function fetchbuyerpodetailsreportCount($params,$buyer_name,$part_number,$from_date,$to_date){
        ...
        $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_BUYER_PO_MASTER_ITEM.'.part_number_id');
        $this->db->join(TBL_BUYER_MASTER, TBL_BUYER_MASTER.'.buyer_id = '.TBL_BUYER_PO_MASTER.'.buyer_name_id');
        // $this->db->where(TBL_FINISHED_GOODS.'.fin_id=',923);
    ...
    public function getexportinvoicedetails($buyer_po_id,$part_number,$buyer_po_part_delivery_date,$buyer_invoice_number){
    ...
    public function calculatesumofallbuyerdetails($buyer_name,$part_number,$from_date,$to_date){
        ...
        $data_11[] = array('total_order_aty'=>$total_order_aty,'export_qty'=>$export_qty);
       return $data_11;
    ...
    public function fetchcompalintrecordsData($params){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['action'] ='';
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."editcomplainform/".$value['cfid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   &nbsp ";
                $data[$counter]['action'] .= "<a href='".ADMIN_PATH."downloadcomplainform/".$value['cfid']."' style='cursor: pointer;' target='_blank' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-print' aria-hidden='true'></i></a>  &nbsp";
...
public function getpreexportitemdetailsdata($params,$id){
    ...
    if(count($fetch_result) > 0)
    {
        foreach ($fetch_result as $key => $value)
        {
            ...
            $data[$counter]['action'] ='';
            $data[$counter]['action'] .= "<a href='".ADMIN_PATH."addexportitemdetailswithattributes/".$value['preexportitemid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-plus-circle' aria-hidden='true'></i></a>   &nbsp ";
            $data[$counter]['action'] .= "<a href='".ADMIN_PATH."editaddpreexportitemdetails/".$value['preexportitemid']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   &nbsp ";
...
public function get_preexport_item_details($part_number,$main_expot_id,$buyer_po_id,$buyer_name_id,$data_buyer_po_date,$data_buyer_po_number){
    ...
    $this->db->where(TBL_FINISHED_GOODS.'.fin_id',$part_number);
    $this->db->where(TBL_BUYER_PO_MASTER_ITEM.'.buyer_po_part_delivery_date',$data_buyer_po_date);
    $this->db->where(TBL_BUYER_PO_MASTER.'.buyer_po_number',$data_buyer_po_number);
    $query = $this->db->get(TBL_BUYER_PO_MASTER_ITEM);
    $fetch_result = $query->result_array();
    return $fetch_result;
...
public function getpreexportitemdetailsattributedata($params,$id){
    ...
    if(count($fetch_result) > 0)
    {
        foreach ($fetch_result as $key => $value)
        {
            ...
            //$data[$counter]['remark'] ='';
            $data[$counter]['action'] ='';
            $data[$counter]['action'] .= "<a href='".ADMIN_PATH."editexportitemdetailswithattributesvalues/".$value['id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   &nbsp ";
...
public function getCHAdata($params){
    ...
    if(count($fetch_result) > 0)
    {
        foreach ($fetch_result as $key => $value)
        {
            ...
            $data[$counter]['contact_person'] =  $value['contact_person'];
            $data[$counter]['action'] = '';
            $data[$counter]['action'] .= "<a href='".ADMIN_PATH."updatecha/".$value['cha_id']."' style='cursor: pointer;' target='_blank'><i style='font-size: x-large;cursor: pointer;' class='fa fa-pencil-square-o' aria-hidden='true'></i></a>   ";
...
public function getDebitnoteitemdeatilsForInvoicevendor($id){
    ...
    // $this->db->select('*,'.TBL_RAWMATERIAL.'.gross_weight as rmgrossweight');
    $this->db->select('*,'.TBL_FINISHED_GOODS.'.net_weight as raw_material_neight_weight,'.TBL_FINISHED_GOODS.'.part_number as fgpart,'.TBL_VENDOR_PO_MASTER_ITEM.'.unit as vendor_po_unit,'.TBL_DEBIT_NOTE_ITEM.'.rate as debit_note_rate,'.TBL_DEBIT_NOTE_ITEM.'.p_and_f_charges as p_nf_charges');
    $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_DEBIT_NOTE_ITEM.'.part_number');
...
public function getchadebitenotenumber(){
    $this->db->select('*');
...
public function getdebitnotedetailsbydebitenoteeid($debit_note_number){
    ...
    // $this->db->join(TBL_BUYER_MASTER, TBL_BUYER_MASTER.'.buyer_id = '.TBL_PACKING_INSTRACTION.'.buyer_name');
    // $this->db->join(TBL_BUYER_PO_MASTER, TBL_BUYER_PO_MASTER.'.id = '.TBL_PACKING_INSTRACTION.'.buyer_po_number');
    $this->db->where(TBL_CHA_DEBIT_NOTE.'.id', $debit_note_number);
    $query = $this->db->get(TBL_CHA_DEBIT_NOTE);
    $data = $query->result_array();
    return $data;
}
...
public function fetchproductionstatusreportcount($params,$vendor_name,$status,$part_number,$vendor_po){
...
public function fetchproductionstatusreportdata($params,$vendor_name,$status,$part_number,$vendor_po){
    ...
    // $this->db->select('*,'.TBL_VENDOR.'.vendor_name as vendorname,'.TBL_BILL_OF_MATERIAL_VENDOR.'.id as billofmaterialid,'.TBL_FINISHED_GOODS.'.part_number as partno,'.TBL_BUYER_MASTER.'.buyer_name as buyer, 2 as flag,'.TBL_BILL_OF_MATERIAL_VENDOR.'.bom_status,'.TBL_VENDOR_PO_MASTER_ITEM.'.order_oty as vendor_order_qty_co,'.TBL_BILL_OF_MATERIAL_VENDOR_ITEM.'.vendor_received_qty as vendor_received_qty_co,'.TBL_VENDOR_PO_MASTER.'.po_number as v_po_number,'.TBL_FINISHED_GOODS.'.name as part_description,'.TBL_VENDOR_PO_MASTER.'.delivery_date,'.TBL_BILL_OF_MATERIAL_VENDOR_ITEM.'.id as vendor_bill_item_id,"Vendor Bill Of Material" as flag,"vbom" as notes_status,'.TBL_BILL_OF_MATERIAL_VENDOR_ITEM.'.notes');
    // $this->db->join(TBL_BILL_OF_MATERIAL_VENDOR_ITEM, TBL_BILL_OF_MATERIAL_VENDOR_ITEM.'.vendor_bill_of_material_id= '.TBL_BILL_OF_MATERIAL_VENDOR.'.id');
    // $this->db->join(TBL_VENDOR, TBL_VENDOR.'.ven_id= '.TBL_BILL_OF_MATERIAL_VENDOR.'.vendor_name');
    // $this->db->join(TBL_VENDOR_PO_MASTER, TBL_VENDOR_PO_MASTER.'.id= '.TBL_BILL_OF_MATERIAL_VENDOR.'.vendor_po_number');
    // $this->db->join(TBL_VENDOR_PO_MASTER_ITEM, TBL_VENDOR_PO_MASTER_ITEM.'.vendor_po_id= '.TBL_VENDOR_PO_MASTER.'.id');
    ...
    $this->db->join(TBL_VENDOR, TBL_VENDOR.'.ven_id= '.TBL_BILL_OF_MATERIAL_VENDOR.'.vendor_name');
    $this->db->join(TBL_VENDOR_PO_MASTER, TBL_VENDOR_PO_MASTER.'.id= '.TBL_BILL_OF_MATERIAL_VENDOR.'.vendor_po_number  and '.TBL_VENDOR_PO_MASTER_ITEM.'.vendor_po_id='.TBL_VENDOR_PO_MASTER.'.id');
    $this->db->join(TBL_BUYER_MASTER, TBL_BILL_OF_MATERIAL_VENDOR.'.buyer_name= '.TBL_BUYER_MASTER.'.buyer_id');
    $this->db->join(TBL_FINISHED_GOODS, TBL_VENDOR_PO_MASTER_ITEM.'.part_number_id= '.TBL_FINISHED_GOODS.'.fin_id');
...
public function getallproductionreportstatusdata($vendor_name,$status,$vendor_po,$part_number){
    ...
    if(count($fetch_result) > 0)
    {
        foreach ($fetch_result as $key => $value)
        {
            ...
            $data[$counter]['vendor_order_qty'] = $value['vendor_order_qty_co'];
            $data[$counter]['vendor_received_qty'] = $value['expected_qty'];
            $data[$counter]['vendor_received_qtys'] = $value['vendor_received_qty_co_vendor_recived'];
            $data[$counter]['delivery_date'] = $value['delivery_date'];
            $data[$counter]['buyer_name'] = $value['buyer'];   
            $data[$counter]['buyer_po_number'] = $value['sales_order_number'];
            $data[$counter]['buyer_po_date'] = $value['buyer_po_date'];  
...
public function getpreviousaddednotesfordisplay($bill_of_material_id,$flag){

    if($flag=='bom'){
        $this->db->select('notes,id,"bom" as flag');
        $this->db->where(TBL_BILL_OF_MATERIAL_ITEM.'.id', $bill_of_material_id);
        $query = $this->db->get(TBL_BILL_OF_MATERIAL_ITEM);
        $data = $query->result_array();
        return $data;
    }
    ...
    if($flag=='vbom'){
        $this->db->select('notes,id,"vbom" as flag');
        $this->db->where(TBL_BILL_OF_MATERIAL_VENDOR_ITEM.'.id', $bill_of_material_id);
        $query = $this->db->get(TBL_BILL_OF_MATERIAL_VENDOR_ITEM);
        $data = $query->result_array();
        return $data;
    ...
    public function downlaodsalestrackingportdata($sales_tracking_report_name,$buyer_name,$from_date,$to_date){
        ...
        if(count($fetch_result) > 0)
        {
            foreach ($fetch_result as $key => $value)
            {
                ...
                $data[$counter]['currency'] = $value['buyer_currency'];
                $data[$counter]['inv_amount'] = $value['inv_amount'];
...
public function getcustomercomplaintdetailsfordownalod($id){
...
public function deleteuspincoming($id){

    $this->db->where('id', $id);
    if($this->db->delete(TBL_USP_INCOMING_FORM)){
        $this->db->where('usp_incoming_id', $id);
...
public function fetchserchstocksrportcount($params){
    $this->db->select('*,'.TBL_BUYER_MASTER.'.buyer_name as by_name,'.TBL_VENDOR.'.vendor_name as ven_name,'.TBL_VENDOR_PO_MASTER.'.po_number as vpo_number,'.TBL_FINISHED_GOODS.'.part_number as fg_part_number');
    $this->db->join(TBL_STOCKS, TBL_STOCKS.'.stock_id = '.TBL_STOCKS_ITEM.'.stock_form_id');
    $this->db->join(TBL_BUYER_PO_MASTER, TBL_BUYER_PO_MASTER.'.id = '.TBL_STOCKS.'.buyer_po_number');
    $this->db->join(TBL_BUYER_MASTER, TBL_BUYER_MASTER.'.buyer_id = '.TBL_STOCKS.'.buyer_name');
    $this->db->join(TBL_VENDOR_PO_MASTER, TBL_VENDOR_PO_MASTER.'.id = '.TBL_STOCKS.'.vendor_po_number');
    ...
    if($params['search']['value'] != "") 
    {
        ...
        $this->db->or_where(TBL_VENDOR_PO_MASTER.".po_number LIKE '%".$params['search']['value']."%'");
        $this->db->or_where(TBL_FINISHED_GOODS.".part_number LIKE '%".$params['search']['value']."%'");
        $this->db->or_where(TBL_STOCKS_ITEM.".invoice_qty_In_pcs LIKE '%".$params['search']['value']."%'");
    ...
    $this->db->where(TBL_STOCKS_ITEM.'.status', 1);
    $this->db->group_by(TBL_STOCKS.'.stock_id_number');
    $this->db->group_by(TBL_STOCKS_ITEM.'.part_number');
    $this->db->order_by(TBL_STOCKS_ITEM.'.id','DESC');
    $query = $this->db->get(TBL_STOCKS_ITEM);
    $rowcount = $query->num_rows();
    return $rowcount;
...
public function getsearchstockvendordeatils($stock_id,$item_id){
    ...
    $this->db->join(TBL_BUYER_PO_MASTER, TBL_BUYER_PO_MASTER.'.id = '.TBL_STOCKS.'.buyer_po_number');
    $this->db->join(TBL_BUYER_PO_MASTER_ITEM, TBL_BUYER_PO_MASTER_ITEM.'.buyer_po_id = '.TBL_BUYER_PO_MASTER.'.id');
    $this->db->join(TBL_BUYER_PO_MASTER_ITEM.' as a', 'a.part_number_id = '.TBL_STOCKS_ITEM.'.part_number');
...
public function getVendorPolistforvendorcompalint($supplier_name){
    $this->db->select('*');
    $this->db->join(TBL_BUYER_MASTER, TBL_BUYER_MASTER.'.buyer_id = '.TBL_VENDOR_PO_MASTER.'.buyer_name');
    $this->db->where(TBL_VENDOR_PO_MASTER.'.vendor_name', $supplier_name);
    // $this->db->where(TBL_VENDOR_PO_MASTER.'.supplier_name !=',"");
...
public function getSuppliritemonlyforsuppliervendorcompalint($supplier_po_number,$flag){
...
public function updatestockaftercalculation($balence_qty_in_pcs,$finishgood_id,$stock_id){
    ...
    public function getUspincomingdetailsdata($params){
        $this->db->select('*,'.TBL_USP_INCOMING_FORM.'.id as usp_incoming_id,'.TBL_USP_INCOMING_FORM.'.remark as mainremark');
        $this->db->join(TBL_USP, TBL_USP.'.usp_id  = '.TBL_USP_INCOMING_FORM.'.usp_name_id');
        $this->db->join(TBL_CHALLAN_FORM, TBL_CHALLAN_FORM.'.challan_id = '.TBL_USP_INCOMING_FORM.'.challan_number_id');
    ...
    public function getallchallanpartusingchallannumber($challan_id){
        ...
        if($query_vendor_data['pre_vendor_supplier_name']=='vendor'){
                ...
                if($query_vendor_data['supplier_po_number']){
                    ...
                    //$this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challanformid,'.TBL_SUPPLIER_PO_MASTER.'.po_number as supplier_po_number,'.TBL_VENDOR_PO_MASTER.'.po_number as vendor_po_number,'.TBL_RAWMATERIAL.'.type_of_raw_material as description1');
                    $this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challan_form_item_id,'.TBL_FINISHED_GOODS.'.name as description1');
                    ...
                    $this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challan_form_item_id,'.TBL_SUPPLIER_PO_MASTER.'.po_number as supplier_po_number,'.TBL_VENDOR_PO_MASTER.'.po_number as vendor_po_number,'.TBL_FINISHED_GOODS.'.name as description1');
                    // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.raw_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
                    //$this->db->join(TBL_FINISHED_GOODS, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
                    $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
                    //$this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
            ...
            $this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challan_form_item_id,'.TBL_SUPPLIER_PO_MASTER.'.po_number as supplier_po_number,'.TBL_VENDOR_PO_MASTER.'.po_number as vendor_po_number,'.TBL_RAWMATERIAL.'.type_of_raw_material as description1');
            // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.raw_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
            // $this->db->join(TBL_FINISHED_GOODS, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
            // $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
            $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.raw_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
    ...
    public function getChallanformitemdetailsbychallanandaprt($part_number,$challan_id){
        ...
        if($query_vendor_data['pre_vendor_supplier_name']=='vendor'){
                ...
                if($query_vendor_data['supplier_po_number']){
                    ...
                    //$this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challanformid,'.TBL_SUPPLIER_PO_MASTER.'.po_number as supplier_po_number,'.TBL_VENDOR_PO_MASTER.'.po_number as vendor_po_number,'.TBL_RAWMATERIAL.'.type_of_raw_material as description1');
                    $this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challan_form_item_id,'.TBL_FINISHED_GOODS.'.name as description1,'.TBL_FINISHED_GOODS.'.net_weight as net_weight1');
                    ...
                    // $this->db->join(TBL_SUPPLIER_PO_MASTER, TBL_SUPPLIER_PO_MASTER.'.id = '.TBL_CHALLAN_FORM_ITEM.'.pre_supplier_po_number','left');
                    $this->db->where(TBL_CHALLAN_FORM_ITEM.'.status',1);
                    $this->db->where(TBL_CHALLAN_FORM_ITEM.'.part_number',$part_number);
                    $this->db->where(TBL_CHALLAN_FORM_ITEM.'.challan_id',$challan_id);
                    $query = $this->db->get(TBL_CHALLAN_FORM_ITEM);
                    $data = $query->result_array();
                    return $data;
                    ...
                    $this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challan_form_item_id,'.TBL_SUPPLIER_PO_MASTER.'.po_number as supplier_po_number,'.TBL_VENDOR_PO_MASTER.'.po_number as vendor_po_number,'.TBL_FINISHED_GOODS.'.name as description1,'.TBL_FINISHED_GOODS.'.net_weight as net_weight1');
                    // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.raw_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
                    //$this->db->join(TBL_FINISHED_GOODS, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
                    $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
                    //$this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
            ...
            $this->db->select('*,'.TBL_CHALLAN_FORM_ITEM.'.id as challan_form_item_id,'.TBL_SUPPLIER_PO_MASTER.'.po_number as supplier_po_number,'.TBL_VENDOR_PO_MASTER.'.po_number as vendor_po_number,'.TBL_RAWMATERIAL.'.type_of_raw_material as description1,'.TBL_RAWMATERIAL.'.net_weight as net_weight1');
            // $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.raw_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
            // $this->db->join(TBL_FINISHED_GOODS, TBL_RAWMATERIAL.'.part_number = '.TBL_FINISHED_GOODS.'.part_number');
            // $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
            $this->db->join(TBL_RAWMATERIAL, TBL_RAWMATERIAL.'.raw_id = '.TBL_CHALLAN_FORM_ITEM.'.part_number');
    ...
    public function saveuspincomingitemformdata($id,$data){

        if($id != '') {
            $this->db->where('id', $id);
            if($this->db->update(TBL_USP_INCOMING_FORM_ITEM, $data)){
                return TRUE;
            } else {
                return FALSE;
            }
            ...
            if($this->db->insert(TBL_USP_INCOMING_FORM_ITEM, $data)) {
                return $this->db->insert_id();
            } else {
                return FALSE;
            }
    ...
    public function update_last_inserted_id_in_uspincoming($last_inserted_id){
        $data = array(
            'usp_incoming_id' => $last_inserted_id
        );
    ...
    public function getuspincomingdetailsforedit($id){

        $this->db->select('*,'.TBL_USP_INCOMING_FORM.'.id as usp_incoming_id,'.TBL_USP_INCOMING_FORM.'.remark as mainremark');
        $this->db->join(TBL_USP, TBL_USP.'.usp_id  = '.TBL_USP_INCOMING_FORM.'.usp_name_id');
        $this->db->join(TBL_CHALLAN_FORM, TBL_CHALLAN_FORM.'.challan_id = '.TBL_USP_INCOMING_FORM.'.challan_number_id');
        $this->db->where(TBL_USP_INCOMING_FORM.'.id', $id);
        $query = $this->db->get(TBL_USP_INCOMING_FORM);
        $fetch_result = $query->row_array();
        return $fetch_result;
    }
...
public function checklotnumberisexitsornotadd($usp_incoming_item_id,$lot_no,$pre_challan_number,$part_number){
   ...
   public function partnumberforpreviousbal($part_number,$challan_id,$usp_incoming_id){
   ...
   public function geteditUspincomingitemdatabyuspitemId($id){
    ...
    $this->db->select('*,'.TBL_USP_INCOMING_FORM_ITEM.'.id as uspincoming_item_id,'.TBL_USP_INCOMING_FORM_ITEM.'.status as item_status,'.TBL_USP_INCOMING_FORM_ITEM.'.pre_remark as itemremark,'.TBL_USP_INCOMING_FORM_ITEM.'.status as itemstatus,'.TBL_USP_INCOMING_FORM_ITEM.'.received_qty_In_pcs as rqip,'.TBL_USP_INCOMING_FORM_ITEM.'.received_qty_In_kgs rqik,'.TBL_USP_INCOMING_FORM_ITEM.'.remark as itemremark');
    $this->db->join(TBL_FINISHED_GOODS, TBL_FINISHED_GOODS.'.fin_id = '.TBL_USP_INCOMING_FORM_ITEM.'.part_number');
    $this->db->join(TBL_CHALLAN_FORM, TBL_CHALLAN_FORM.'.challan_id = '.TBL_USP_INCOMING_FORM_ITEM.'.pre_challan_number');
