...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> View CHA Debit Note
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">View Debit Note Master</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Debit Note Detials</h3>
                        </div>
                        ...
                        <form role="form" id="savechadebitnoteform"
                            ...
                            <input  readonly type="hidden" class="form-control" id="cha_debit_note_id"
                                ...
                                <div class="col-sm">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="cha_debit_note_number"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="cha_debit_note_date">CHA Debit Note Date <span
                                                    class="required">*</span></label>
                                            <input  readonly type="text" class="form-control datepicker"  value="<?=$getchadebitnotedetails[0]['cha_debit_note_date']?>"  id="cha_debit_note_date"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="cha_name_date">CHA Name <span
                                                    class="required">*</span></label>
                                            <select  readonly class="form-control" name="cha_name" id="cha_name">
                                ...
                                <div class="col-sm">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control"  value="<?=$getchadebitnotedetails[0]['subject']?>"  id="subject"
                                ...
                                <div class="col-sm">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control"  value="<?=$getchadebitnotedetails[0]['invoice_1']?>"  id="invoice_1"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="invoice_2" value="<?=$getchadebitnotedetails[0]['invoice_2']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="invoice_3" value="<?=$getchadebitnotedetails[0]['invoice_3']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control datepicker" id="date_1" value="<?=$getchadebitnotedetails[0]['date_1']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control datepicker" id="date_2" value="<?=$getchadebitnotedetails[0]['date_2']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control datepicker" id="date_3" value="<?=$getchadebitnotedetails[0]['date_3']?>"
                                        ...
                                        <div class="row" style="padding: 4px;" id="row<?=$i?>">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input  readonly type="text" class="form-control" value="<?=$value['AWB_No'] ?>" id="AWB_No" name="AWB_No[]"
                                                        required>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="debit_amount">Debit Amount <span
                                                            class="required">*</span></label>
                                                    <input  readonly type="number" class="form-control"  value="<?=$value['debit_amount'] ?>" id="debit_amount"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input  readonly type="number" class="form-control" id="SGST" value="<?=$value['SGST'] ?>" name="SGST[]"
                                                        required>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input  readonly type="text" class="form-control" id="CGST"  value="<?=$value['CGST'] ?>" name="CGST[]"
                                                        required>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input  readonly type="text" class="form-control" id="total" value="<?=$value['total'] ?>"  name="total[]"
                                                        required>
                                ...
                                <div class="col-sm">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="taxable_amount" value="<?=$getchadebitnotedetails[0]['taxable_amount']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="cgst_sgst" name="cgst_sgst" value="<?=$getchadebitnotedetails[0]['cgst_sgst']?>"
                                                required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="bill_amount" name="bill_amount" value="<?=$getchadebitnotedetails[0]['bill_amount']?>"
                                                required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="debit_amount" value="<?=$getchadebitnotedetails[0]['debit_amount']?>"
                                                name="debit_amount" required>
                                            <p class="error debit_amount_error"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="amount_payable_before_tds" value="<?=$getchadebitnotedetails[0]['amount_payable_before_tds']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" id="less_tds" name="less_tds"  value="<?=$getchadebitnotedetails[0]['less_tds']?>"
                                                required> 
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" name="payable_amount" value="<?=$getchadebitnotedetails[0]['payable_amount']?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" class="form-control" name="remark" value="<?=$getchadebitnotedetails[0]['remark']?>"
                            ...
                            <div class="box-footer">
                                <input  readonly type="button" onclick="location.href = '<?php echo base_url() ?>chadebitnote'"
