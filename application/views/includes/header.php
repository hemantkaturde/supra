    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            ?>
                    ...
                    <li class="treeview <?php if($pageUrl=="jobWork" || $pageUrl=="addjobwork" || $pageUrl=="editjobwork" ||  $pageUrl=="scrapreturn" || $pageUrl=="addnewScrapreturn" || $pageUrl=="editscrapreturn" || $pageUrl=="reworkrejectionreturn" || $pageUrl=="addneworkrejection" || $pageUrl=="editreworkrejection" || $pageUrl=="challanform" || $pageUrl=="addchallanform" || $pageUrl=="editchallanform" || $pageUrl=="debitnote" || $pageUrl=="paymentdetails" || $pageUrl=="poddetails" || $pageUrl=="addnewdebitnote"){echo 'active';}?>">
                      <a href="#">
                      ...
                      <ul class="treeview-menu" >
                        ...
                        <li class="line_height <?php if($pageUrl=="debitnote" || $pageUrl=="addnewdebitnote"){echo 'active';}?>"><a href="<?php echo base_url(); ?>debitnote"><i class="fa fa-cubes"></i> Debit Note</a></li>
