    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            ?>
                    ...
                    <li class="treeview <?php if($pageUrl=="suppliermaster" || $pageUrl=="addnewSupplier" || $pageUrl=='updateSupplier' || $pageUrl=='rowmaterialmaster' || $pageUrl=='addnewmaterialdata' || $pageUrl=='updateRawmaterial' || $pageUrl=="vendormaster" || $pageUrl=='addnewVendor' || $pageUrl=='updateVendor'){echo 'active';}?>">
                      <a href="#">
                      ...
                      <ul class="treeview-menu" >
                        ...
                        <li class="line_height"><a href="#"><i class="fa fa-cubes"></i> USP Master</a></li>
