<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> View Credit Note
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">View Credit Note</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Credit Note Details</h3>
                        </div>
                        ...
                        <form role="form" id="addnnewcreditnoteform" action="<?php echo base_url() ?>addnnewcreditnoteform" method="post" role="form">
                            <div class="box-body">
                                <div class="col-md-4">
                                 ...
                                 <input readonly  type="hidden" class="form-control" id="cerdit_note_id" name="cerdit_note_id" value="<?=$getcreditenotedetails['cerdit_note_id']?>" required readonly>

                                    
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="credit_note_number">Credit Note Number<span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control" id="credit_note_number" name="credit_note_number" value="<?=$getcreditenotedetails['credit_note_number']?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="date">Date <span class="required">*</span></label>
                                             <input readonly  type="text" class="form-control datepicker"  value="<?=$getcreditenotedetails['credit_note_date']?>" id="date" name="date" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                                <label for="buyer_name">Buyer Name <span class="required">*</span></label>
                                                 <select readonly  class="form-control buyer_name_for_currency" name="buyer_name" id="buyer_name">
                                    ...
                                    <div class="col-md-12 buyer_po_number_div" >
                                            <div class="form-group">
                                                    <label for="buyer_po_number">Select Buyer PO Number <span class="required">*</span></label>
                                                     <select readonly  class="form-control buyer_po_number_for_item buyer_po_number_for_export_invoice" name="buyer_po_number" id="buyer_po_number">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="Currency">Currency</label>
                                             <input readonly  type="text" class="form-control" id="currency" name="currency" value="<?=$getcreditenotedetails['currency']?>" required readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="remark">Remark</label>
                                             <input readonly  type="text" class="form-control" id="remark" name="remark" value="<?=$getcreditenotedetails['creditnoteremark'] ?>">
                                    ...
                                    <div class="modal fade" id="addNewModal" role="dialog" aria-labelledby="additem" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <form role="form" id="savecreditnoteinformationform" action="<?php echo base_url() ?>savecreditnoteinformationform" method="post" role="form">
                                                 ...
                                                 <input readonly  type="hidden" class="form-control"  id="cerdit_note_item_id" name="cerdit_note_item_id" required readonly>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <select readonly  class="form-control part_number_for_export_invoice" name="part_number" id="part_number">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <select readonly  class="form-control invoice_number" name="invoice_number" id="invoice_number">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="invoice_value" name="invoice_value">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="recivable_amount" name="recivable_amount">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                             <input readonly  type="text" class="form-control"  id="diff_value" name="diff_value">
                            ...
                            <div class="box-footer">
                                <div class="col-xs-8">
                                    <?php if($fetchALLpreCredititemList){
                                     ...
                                     <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>creditnote'" class="btn btn-default" value="Back" />
                                </div>
                            </div>
                        </form>
                    </div>
