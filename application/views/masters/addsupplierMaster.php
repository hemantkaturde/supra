<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Add New Supplier
            <small>
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" id="addnewsupplierform" action="<?php echo base_url() ?>addnewsupplierform" method="post" role="form">
                            ...
                            <div class="box-footer">
                                <input type="submit" id="savenewsupplier" class="btn btn-primary" value="Submit" />
                                <input type="button" onclick="location.href = '<?php echo base_url() ?>suppliermaster'" class="btn btn-default" value="Back" />
                            </div>
                        </form>
                    </div>
                </div>
