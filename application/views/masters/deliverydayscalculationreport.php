<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Delivery Days Calculation Report
            <small>
                <ul class="breadcrumb" style="background-color:#ecf0f5 !important">
                    <li class="completed"><a href="javascript:void(0);">Masters</a></li>
                    <li class="active"><a href="javascript:void(0);">Delivery Days Calculation Report</a></li>
                </ul>
            </small>
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Delivery Days Calculation Report</h3>
                        </div>
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div style="margin-top:22px">
                                            ...
                                            <input type="button" class="btn btn-primary" value="Export To Excel"
                                                id="export_to_excel_delivery_days_report" name="export_to_excel_delivery_days_report" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover"
                                    id="view_delivery_days_calculation_report">
                                    <thead>
