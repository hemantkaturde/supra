                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="total_debit_amount_ok_qty">Total Amount of OK Quantity <span class="required">*</span></label>
                                                  ...
                                                  <input type="text" class="form-control"  value="<?=$totalDebitAndokQty['total_amount_of_ok_qty_data']+$totalDebitAndokQty['SGST_value_ok_val']+$totalDebitAndokQty['CGST_value_ok_val']+$totalDebitAndokQty['IGST_value_ok_val']?>" id="total_amount_of_ok_qty_data" name="total_amount_of_ok_qty_data" required readonly>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="freight_amount_charge">Grand Total <span class="required">*</span></label>
                                                  <input type="text" class="form-control"  value="<?=round($grand_total)?>" id="grand_total_main" name="grand_total_main" required>
