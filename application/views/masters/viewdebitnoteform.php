<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> View Debit Note
            <small>
                ...
                <div class="box">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">View Debit Note</h3>
                        </div>
                        ...
                        <form role="form" id="addnewdebitnoteform" action="<?php echo base_url() ?>addnewdebitnoteform" method="post" role="form">
                            <div class="box-body">
                                ...
                                <input readonly  type="hidden" class="form-control" id="debit_id" value="<?=$getdebitnoteditailsdata[0]['debit_id']?>" name="debit_id" readonly>

                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="debit_note_number">Debit Note Number<span class="required">*</span></label>
                                            <input readonly  type="text" class="form-control" id="debit_note_number" value="<?=$getdebitnoteditailsdata[0]['debit_note_number']?>" name="debit_note_number" readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input readonly  type="text" class="form-control datepicker"  value="<?=$getdebitnoteditailsdata[0]['debit_note_date']?>" id="debit_note_date" name="debit_note_date" required>
                                    ...
                                    <!-- <div class="col-md-12">
                                        <div class="form-group">
                                                <label for="select_with_po_without_po">Select With PO / Without PO <span class="required">*</span></label>
                                                 <select readonly  class="form-control" name="select_with_po_without_po" id="select_with_po_without_po">
                                            ...
                                            <div class="col-md-12 supplier_po_number_div" id="supplier_po_number_div" style="display: <?=$display?>">
                                                <div class="form-group">
                                                        <label for="supplier_po_number">Select Supplier PO Number</label>
                                                             <select readonly  class="form-control supplier_po_number_item supplier_po_number_for_item" name="supplier_po_number" id="supplier_po_number">
                                                                <!-- <option st-id="" value="">Select Vendor Name</option> -->
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="po_date">PO Date</label>
                                                  <input readonly  type="text" class="form-control datepicker"  value="<?=$getdebitnoteditailsdata[0]['debit_po_date']?>" id="po_date" name="po_date" required>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="total_debit_amount">Total Debit Amount <span class="required">*</span></label>
                                                  <input readonly  type="text" class="form-control"  value="<?=number_format($totalDebitAndokQty['total_debit_amount'] + $totalDebitAndokQty['total_SGST_value'] + $totalDebitAndokQty['total_CGST_value'] + $totalDebitAndokQty['total_IGST_value'], 2, '.', ','); ?>" id="total_debit_amount" name="total_debit_amount" required readonly>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="total_debit_amount_ok_qty">Total Amount of OK Quantity <span class="required">*</span></label>
                                                  <!-- <input readonly  type="text" class="form-control"  value="<?=$totalDebitAndokQty['total_amount_of_ok_qty_data']?>" id="total_amount_of_ok_qty_data" name="total_amount_of_ok_qty_data" required readonly> -->
                                                  ...
                                                  <input readonly  type="hidden" class="form-control"  value="<?=$totalDebitAndokQty['total_amount_of_ok_qty']?>" id="total_amount_of_ok_qty" name="total_amount_of_ok_qty" required readonly>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="tds_amount">TDS Amount <span class="required">*</span></label>
                                                  <input readonly  type="text" class="form-control"  value="<?=$tds?>" id="tds_amount" name="tds_amount" required>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="freight_amount_charge">Courier/Return Charges <span class="required">*</span></label>
                                                  <input readonly  type="text" class="form-control"  value="<?=$cr ?>" id="freight_amount_charge" name="freight_amount_charge" required>
                                                <p class="error freight_amount_charge_error"></p>
                                            </div>
                                    </div>
                                    
                                    <input readonly  type="hidden" class="form-control" value="<?=$totalDebitAndokQty['p_and_f_charges']?>"  id="p_and_f_charges_main" name="p_and_f_charges_main">

                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="chq_amt">Chq Amount <span class="required">*</span></label>
                                                  <input readonly  type="text" class="form-control"  value="<?=$getdebitnoteditailsdata[0]['chq_amount']?>" id="chq_amt" name="chq_amt" required>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="freight_amount_charge">Grand Total <span class="required">*</span></label>
                                                  <input readonly  type="text" class="form-control"  value="<?=round($totalDebitAndokQty['total_normal_gst_value_plus_total'],2)?>" id="grand_total_main" name="grand_total_main" required>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="remark">Remark</label>
                                                  <textarea readonly type="text" class="form-control"  id="remark"  name="remark" required> <?=$getdebitnoteditailsdata[0]['debit_remark'];?></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="modal fade" id="addNewModal" role="dialog" aria-labelledby="additem" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <input readonly  type="hidden" class="form-control"  id="debit_note_item_id" name="debit_note_item_id" required readonly>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="ok_qty" name="ok_qty">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="less_quantity" name="less_quantity">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="text" class="form-control"  id="rejected_quantity" name="rejected_quantity">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="received_quantity" name="received_quantity">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label" for="p_and_f_charges">P and F Charges <span class="required">*</span></label>
                                                            <div class="col-sm-8">
                                                                    <input readonly  type="number" class="form-control"  id="p_and_f_charges" name="p_and_f_charges" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="rate" name="rate" readonly>
                                                    ...
                                                    <div class="form-group row cgst_sgst_ok_9_div" style="display:none">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input readonly  type="number" class="form-control"  id="SGST_rate_9_ok" name="SGST_rate_9_ok" readonly>
                                                            <p class="error SGST_rate_error"></p>
                                                        </div>

                                                        <label class="col-sm-2 col-form-label">CGST 9 % (<small> SGST Value for OK Qty</small>)<span class="required">*</span></label>
                                                        <div class="col-sm-4">
                                                            <input readonly  type="number" class="form-control"  id="CGST_rate_9_ok" name="CGST_rate_9_ok" readonly>
                                                    ...
                                                    <div class="form-group row cgst_sgst_ok_6_div" style="display:none">
                                                        <label class="col-sm-2 col-form-label">SGST 6 % (<small> SGST Value for Debit Qty</small>)<span class="required">*</span></label>
                                                        <div class="col-sm-4">
                                                            <input readonly  type="number" class="form-control"  id="SGST_rate_6_ok" name="SGST_rate_6_ok" readonly>
                                                            <p class="error SGST_rate_error"></p>
                                                        </div>

                                                        <label class="col-sm-2 col-form-label">CGST 6 % (<small> SGST Value for Debit Qty</small>)<span class="required">*</span></label>
                                                        <div class="col-sm-4">
                                                            <input readonly  type="number" class="form-control"  id="CGST_rate_6_ok" name="CGST_rate_6_ok" readonly>
                                                    ...
                                                    <div class="form-group row igst_ok_qty_div" style="display:none">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="igst_rate_ok_18" name="igst_rate_ok_18" readonly>
                                                    ...
                                                    <div class="form-group row igst_ok_div_12_div" style="display:none">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="igst_rate_ok_12" name="igst_rate_ok_12" readonly>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input readonly  type="number" class="form-control"  id="debit_amount" name="debit_amount" readonly>
                                                    ...
                                                    <input readonly  type="hidden" class="form-control"  id="total_qty_into_rate" name="total_qty_into_rate" readonly>
                                                    <input readonly  type="hidden" class="form-control"  id="total_qty_normal_qty_plus_pnf" name="total_qty_normal_qty_plus_pnf" readonly>
                                                    <input readonly  type="hidden" class="form-control"  id="total_normal_gst_value" name="total_normal_gst_value" readonly>
                                                    <input readonly  type="hidden" class="form-control"  id="total_normal_gst_value_plus_total" name="total_normal_gst_value_plus_total" readonly>
                            ...
                            <div class="box-footer">
                                <div class="col-xs-8">
                                    ...
                                    <input readonly  type="button" onclick="location.href = '<?php echo base_url() ?>debitnote'" class="btn btn-default" value="Back" />
                                </div>
                            </div>
                        </form>
                    </div>
