...
class Admin_model extends CI_Model
{
    ...
    public function fetchALLpreVendoritemList(){
        ...
        $this->db->join(TBL_SUPPLIER_PO_MASTER, TBL_SUPPLIER_PO_MASTER.'.id = '.TBL_VENDOR_PO_MASTER_ITEM.'.pre_supplier_po_number');
    ...
    public function getSupplieritemsonly($supplier_po_number){
    ...
    public function fetchALLprejobworkitemList(){
        ...
        $this->db->join(TBL_SUPPLIER, TBL_SUPPLIER.'.sup_id = '.TBL_JOB_WORK_ITEM.'.pre_raw_material_supplier_name');
